...
#ifdef _MSC_VER
#pragma message("Warning: Resource manager tests temporarily disabled - see GitHub issue #XXX")
#else
#warning "Resource manager tests temporarily disabled - see GitHub issue #XXX"
#endif
